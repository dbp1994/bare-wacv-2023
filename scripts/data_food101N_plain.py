...
def gen_train_list():
    root_data_path = './data/food101/food-101n/Food-101N_release/meta/imagelist.tsv'
    class_list_path = './data/food101/food-101n/Food-101N_release/meta/classes.txt'

    file_path_prefix = './data/food101/food-101n/Food-101N_release/images'
...
def gen_test_list(arg_map_name2cat):
    ...
    root_data_path = './data/food101/food-101n/Food-101N_release/meta/test.txt'
